...
template<class Type>
const Foam::wordList Foam::fv::LinearSource<Type>::volumeModeTypeNames_
(
...
template<class Type>
typename Foam::fv::LinearSource<Type>::volumeModeType
Foam::fv::LinearSource<Type>::wordToVolumeModeType
(
    const word& vmtName
) const
{
...
template<class Type>
Foam::word Foam::fv::LinearSource<Type>::volumeModeTypeToWord
(
...
template<class Type>
void Foam::fv::LinearSource<Type>::setFieldData(const dictionary& dict)
{
...
template<class Type>
Foam::fv::LinearSource<Type>::LinearSource
(
    const word& name,
...
template<class Type>
void Foam::fv::LinearSource<Type>::addSup
(
    fvMatrix<Type>& eqn,
    const label fieldi
)
{
    if (debug)
    {
        Info<< "LinearSource<" << pTraits<Type>::typeName
