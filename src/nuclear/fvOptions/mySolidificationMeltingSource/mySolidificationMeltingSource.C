...
namespace Foam
{
    ...
    <
        fv::mySolidificationMeltingSource::thermoMode,
        2
    >::names[] =
    {
        "thermo",
...
const Foam::NamedEnum<Foam::fv::mySolidificationMeltingSource::thermoMode, 2>
    Foam::fv::mySolidificationMeltingSource::thermoModeTypeNames_;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

Foam::tmp<Foam::volScalarField>
Foam::fv::mySolidificationMeltingSource::Cp() const
{
    switch (mode_)
    {
        case mdThermo:
...
Foam::vector Foam::fv::mySolidificationMeltingSource::g() const
{
...
void Foam::fv::mySolidificationMeltingSource::update(const volScalarField& Cp)
{
